...
ggplot(orders, aes(x = diff_horas_criacao_inicio_janela)) +
  geom_histogram(breaks = c(seq(0, 72, by = 4), seq(96, max(orders$diff_horas_criacao_inicio_janela, na.rm = TRUE) + 24, by = 24)), fill = "red", color = "black") +
  labs(title = "Pedidos x Delta Criação e Janela de Entrega", x = "Delta horas", y = "Pedidos")
```
